...
function [gzsl_seen_acc, gzsl_unseen_acc, H] = Bayesian_ZSL(x_tr, y_tr, x_ts_us, y_ts_us, x_ts_s, y_ts_s, att, varargin)
    
    % Seen and unseen classes
    us_classes  = unique(y_ts_us);
    s_classes   = unique(y_ts_s);
    ...
    % Mode of these iterations to alleviate the effect of r.v.
    ...
    for i=1:nclass
        ...
        acc_per_class(i) = sum(y_ts_us(idx) == ypred1(idx)) / length(idx);
    end
